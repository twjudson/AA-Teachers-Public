...
<!-- aa-teachers customizations for ALL LaTeX runs of any type -->
...
<xsl:import href="aa-teachers-common.xsl" />
...
<xsl:template name="aa-teachers-terminology">
...
<xsl:template name="aa-teachers-proof-heading">
...
<!-- tcolorbox environment for aa-teachers "Historical Notes"    -->
...
<!-- Eventually this will be an "aside-like"              -->
 <xsl:template name="aa-teachers-historical-environment">
    <xsl:text>% Environment for Historical Notes (aa-teachers-specific)&#xa;</xsl:text>
    <xsl:text>\tcbset{ aa-teachershistoricalstyle/.style={size=minimal, boxrule=-0.3pt, frame empty, colback=white, colbacktitle=white, coltitle=black, fonttitle=\itshape\bfseries, before skip=3ex, bottomtitle=2ex, breakable, title={\raisebox{3pt}{\framebox[0.3\textwidth]{\relax}} \hfill {Historical Note} \hfill \raisebox{3pt}{\framebox[0.3\textwidth]{\relax}}}} }&#xa;</xsl:text>
    <xsl:text>\newtcolorbox{historicalnote}{aa-teachershistoricalstyle}&#xa;</xsl:text>
</xsl:template>
...
<xsl:param name="latex.preamble.late">
    <xsl:call-template name="aa-teachers-terminology" />
    <xsl:call-template name="aa-teachers-proof-heading" />
    <xsl:call-template name="aa-teachers-historical-environment" />
</xsl:param>
